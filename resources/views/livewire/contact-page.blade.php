<main class="pt-24 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20">
        ...
        <div>
            ...
            <div class="space-y-6 md:space-y-8">
                ...
                <div class="flex items-center gap-4 md:gap-6 group">
                    ...
                    <div class="min-w-0">
                        <p class="text-[10px] md:text-xs font-black uppercase text-zinc-400">Chat with Me</p>
            ...
            <div class="mt-12 md:mt-20">
                ...
                <div class="flex gap-3 md:gap-4">
                    <a href="#" class="w-10 h-10 md:w-12 md:h-12 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center hover:border-mint transition-all">
        ...
        <div class="bg-zinc-50 dark:bg-zinc-900 p-6 sm:p-8 md:p-12 rounded-3xl md:rounded-[3rem]">
