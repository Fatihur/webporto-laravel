    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20">
        ...
        <div class="transition-all duration-1000 transform" x-bind:class="show ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'">
            ...
            <div class="space-y-6 md:space-y-8">
                <a href="mailto:fatihur17@gmail.com" class="flex items-center gap-4 md:gap-6 group hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300">
                    ...
                    <div class="min-w-0">
                        <p class="text-[10px] md:text-xs font-black uppercase text-zinc-400 group-hover:text-mint transition-colors">Email Me</p>
                ...
                <div class="flex items-center gap-4 md:gap-6 group hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 cursor-pointer">
                    ...
                    <div class="min-w-0">
                        <p class="text-[10px] md:text-xs font-black uppercase text-zinc-400 group-hover:text-violet transition-colors">Chat with Me</p>
                        <p class="text-base md:text-lg font-bold">+1 (555) 000-1111</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 md:mt-20">
                ...
                <div class="flex gap-3 md:gap-4">
                    <a href="#" class="w-10 h-10 md:w-12 md:h-12 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center hover:border-mint hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" md:width="20" md:height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                    </a>
                    <a href="#" class="w-10 h-10 md:w-12 md:h-12 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center justify-center hover:border-mint hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
