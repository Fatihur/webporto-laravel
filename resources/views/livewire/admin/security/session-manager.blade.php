<div>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Manage your active sessions across all devices') }}
        </p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        @if (count($sessions) > 1)
            <div class="p-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                ...
                >
                    {{ __('Terminate All Other Sessions') }}
                </button>
            </div>
        @endif
        ...
        @if (empty($sessions))
            <div class="p-8 text-center">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">{{ __('No active sessions found') }}</p>
            </div>
        @endif
    </div>
    ...
    <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
        ...
        <ul class="text-sm text-blue-700 dark:text-blue-400 space-y-1">
            <li>{{ __('If you see any suspicious sessions, terminate them immediately and change your password.') }}</li>
            <li>{{ __('Enable two-factor authentication for an extra layer of security.') }}</li>
            <li>{{ __('Always log out from shared or public computers.') }}</li>
        </ul>
    </div>
</div>
