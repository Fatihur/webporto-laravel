                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('home') }}#about" wire:navigate x-on:click="mobileMenuOpen = false" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors font-bold">
